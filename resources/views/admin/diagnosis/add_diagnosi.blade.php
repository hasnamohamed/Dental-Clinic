        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    ...
                    @endif
                    <div class="col-12">
                        <form action="{{ route('diagnosis.store') }}" method="POST" enctype="multipart/form-data" class="addpatient">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <a href="{{ route('diagnosis.index') }}" class="btn btn-secondary">Cancel</a>
                            </div>
                        </form>
                    </div>
                    <!-- /.col -->
