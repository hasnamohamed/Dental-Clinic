    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <form action="{{ route('diagnosis.update', $diagnosi->id) }}" method="POST" class="updateDoctor">
                            @csrf
                            <div class="mb-3">
                                <label for="name" class="form-label">Diagnosis Name</label>
                                <input type="text" class="form-control" id="name" name="name"
                                    aria-describedby="nameHelp" value="{{ $diagnosi->name }}">
                                @error('name')
                                    <div class="col-auto">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="price" name="price"
                                    aria-describedby="phoneHelp" value="{{ $diagnosi->price }}">
                                @error('price')
                                    <div class="col-auto">
