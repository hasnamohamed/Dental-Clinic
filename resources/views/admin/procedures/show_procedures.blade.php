                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title"> Red Test</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <table id="example1" class="table table-bordered table-striped table-responsive">
                                    ...
                                    <tbody>
                                        @foreach ($redTests as $redTest)
                                        <tr>
                                            <td>{{ $redTest->name }}</td>
                                            <td>{{ $redTest->price}}</td>
                                            <td>
                                                <form action="{{ route('redtests.edit', $redTest->id) }}"
                                                    method="GET">
                                                    @csrf
                                            ...
                                            <td>
                                                <form action="{{ route('redtests.delete',$redTest->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('delete')
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Drug Prescriptions</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <table id="example1" class="table table-bordered table-striped table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('prescriptions.edit', $prescription->id) }}"
                                                    method="GET">
                                                    @csrf
                                                    <button type="submit" class="btn btn-outline-info">Edit</button>
                                                </form>
                                            ...
                                            <td>
                                                <form action="{{ route('prescriptions.delete',$prescription->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('delete')
                                                    <button type="submit" class="btn btn-outline-danger"
                            ...
                            <div class="card-body">
                                <table id="example1" class="table table-bordered table-striped table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{ $diagnosi->name }}</td>
                                            <td>{{ $diagnosi->price}}</td>
                                            <td>
                                                <form action="{{ route('diagnosis.edit', $diagnosi->id) }}"
                                                    method="GET">
                                                    @csrf
                                                    <button type="submit" class="btn btn-outline-info">Edit</button>
                                                </form>
                                            ...
                                            <td>
                                                <form action="{{ route('diagnosis.delete',$diagnosi->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('delete')
                                                    <button type="submit" class="btn btn-outline-danger"
