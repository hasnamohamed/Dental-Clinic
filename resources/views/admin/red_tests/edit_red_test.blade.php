    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Update Red Test</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item active">Update Red Test</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <form action="{{ route('redtests.update', $redTest->id) }}" method="POST" class="updateDoctor">
                            @csrf
                            <div class="mb-3">
                                <label for="name" class="form-label">Red Test Name</label>
                                <input type="text" class="form-control" id="name" name="name"
                                    aria-describedby="nameHelp" value="{{ $redTest->name }}">
                                @error('name')
                                    <div class="col-auto">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="price" name="price"
                                    aria-describedby="phoneHelp" value="{{ $redTest->price }}">
                                @error('price')
                                    <div class="col-auto">
